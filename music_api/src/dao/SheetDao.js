...
class SheetDao {
  async findAll(page = 1, pageSize = 10) {
    try {
      ...
      const sql = 'SELECT * FROM t_sheet_list ORDER BY created DESC LIMIT ? OFFSET ?';
  ...
  async findById(id) {
    try {
      const sql = 'SELECT * FROM t_sheet_list WHERE id = ?';
  ...
  async findByUserId(userId, page = 1, pageSize = 10) {
    try {
      ...
      const sql = 'SELECT * FROM t_sheet_list WHERE user_id = ? ORDER BY created DESC LIMIT ? OFFSET ?';
